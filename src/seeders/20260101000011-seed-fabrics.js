    ...
    const fabrics = [
      {
        ...
        color: 'Charcoal',
        image_url: '/images/fabrics/charcoal-wool-twill.png',
        price_cents: 480000,
        in_stock: true,
        sort_order: 1,
      },
      {
        ...
        color: 'Midnight Blue',
        image_url: '/images/fabrics/midnight-herringbone.png',
        price_cents: 620000,
        in_stock: true,
        sort_order: 2,
      },
      {
        ...
        material: '100% Wool',
        color: 'Dove Grey',
        image_url: '/images/fabrics/dove-grey-sharkskin.png',
        price_cents: 510000,
        in_stock: true,
        sort_order: 3,
      },
      {
        ...
        color: 'Bordeaux',
        image_url: '/images/fabrics/bordeaux-flannel.png',
        price_cents: 560000,
        in_stock: true,
        sort_order: 4,
      },
      {
        ...
        color: 'Sand',
        image_url: '/images/fabrics/sand-linen-blend.png',
        price_cents: 495000,
        in_stock: true,
        sort_order: 5,
      },
      {
        ...
        material: '100% Wool Flannel',
        color: 'Forest Green',
        image_url: '/images/fabrics/forest-green-flannel.png',
        price_cents: 575000,
        in_stock: true,
        sort_order: 6,
      },
